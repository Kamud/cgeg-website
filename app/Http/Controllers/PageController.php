    ...
    private function divisionsData(): array
    {
        return [
            'construction' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-building-office-2', 'title' => 'Sandton Hydon Park Mall', 'desc' => 'Flagship two-floor mixed-use retail, office, and fuel station development west of Harare — CGEG\'s landmark return to Zimbabwe after 17 years.'],
                    ['icon' => 'hi-academic-cap',  'title' => 'CIDB Registered',     'desc' => 'Certified with the Construction Industry Development Board across all relevant grading designations.'],
                    ['icon' => 'hi-users',        'title' => '25,000+ Jobs Impact', 'desc' => 'Committed to creating local jobs and skills transfer — every project evaluated for its employment impact.'],
                ],
                'services'    => [
                    ['icon' => 'hi-building-office',    'title' => 'Commercial Development', 'desc' => 'Office parks, retail centres, and mixed-use commercial developments.'],
                    ['icon' => 'hi-flag',        'title' => 'Civil Infrastructure',   'desc' => 'Roads, bridges, drainage, and public infrastructure projects.'],
                    ['icon' => 'hi-home',        'title' => 'Residential Estates',    'desc' => 'Premium housing developments, estates, and residential complexes.'],
                    ['icon' => 'hi-academic-cap', 'title' => 'Project Management',     'desc' => 'End-to-end construction management, scheduling, and consulting.'],
                ],
            ...
            'mining' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-leaf',        'title' => 'Responsible Mining',   'desc' => 'All operations with mandatory environmental impact assessments and comprehensive land rehabilitation plans.'],
                    ['icon' => 'hi-users',       'title' => 'Community First',       'desc' => 'Local procurement, employment, and skills development embedded in every contract and operation.'],
                    ['icon' => 'hi-shield-check','title' => 'Safety Culture',        'desc' => 'Zero-harm safety philosophy with full COIDA compliance across all active mining sites.'],
                ],
                'services'    => [
                    ['icon' => 'hi-sparkles',  'title' => 'Mineral Extraction',      'desc' => 'Gold, chrome, coal, platinum, and precious mineral extraction operations.'],
                    ['icon' => 'hi-magnifying-glass',   'title' => 'Geological Exploration',  'desc' => 'Geological surveys, drilling, and prospecting services.'],
                    ['icon' => 'hi-truck',    'title' => 'Mining Logistics',         'desc' => 'Ore transport, processing chain management, and bulk handling.'],
                    ['icon' => 'hi-leaf',     'title' => 'Rehabilitation',           'desc' => 'Sustainable mining practices and post-operation land rehabilitation.'],
                ],
            ...
            'logistics' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-globe-alt',       'title' => 'Pan-African Network',  'desc' => 'Established routes and partnerships across all 56 CGEG operating countries.'],
                    ['icon' => 'hi-clock',     'title' => 'The Founding Division','desc' => 'Started in 1997 — logistics is the backbone that made everything else possible.'],
                    ['icon' => 'hi-shield-check','title' => 'Customs Expertise',    'desc' => 'Deep knowledge of cross-border customs, documentation, and compliance requirements.'],
                ],
                'services'    => [
                    ['icon' => 'hi-truck',   'title' => 'Road Freight',  'desc' => 'Cross-border and domestic trucking across Southern and East Africa.'],
                    ['icon' => 'hi-paper-airplane',   'title' => 'Air Freight',   'desc' => 'Time-critical cargo, express courier, and perishable goods logistics.'],
                    ['icon' => 'hi-truck',    'title' => 'Sea Freight',   'desc' => 'Container shipping, breakbulk, and port logistics management.'],
                    ['icon' => 'hi-archive-box', 'title' => 'Warehousing',   'desc' => 'Secure storage, inventory management, and fulfilment services.'],
                ],
            ...
            'mall' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-building-storefront','title' => 'Sandton Hydon Park',  'desc' => 'US$670M two-floor mixed-use mall with retail, office space, and fuel station — west of Harare City.'],
                    ['icon' => 'hi-users',         'title' => '5,000 Jobs Impact',   'desc' => 'Projected 2,000–5,000 direct and indirect jobs created on completion.'],
                    ['icon' => 'hi-flag',          'title' => 'Zimbabwe Re-Entry',   'desc' => 'CGEG\'s landmark return after 17 years — designed to inspire further foreign investment.'],
                ],
                'services'    => [
                    ['icon' => 'hi-shopping-cart','title' => 'Retail Leasing',  'desc' => 'Premium retail space for national and international brands.'],
                    ['icon' => 'hi-building-office',     'title' => 'Mall Development', 'desc' => 'End-to-end development of retail and lifestyle centres.'],
                    ['icon' => 'hi-users',        'title' => 'Mall Management',  'desc' => 'Operations, security, cleaning, and tenant relations.'],
                    ['icon' => 'hi-building-storefront',  'title' => 'Mixed-Use Assets', 'desc' => 'Fuel station, office space, and commercial hub management.'],
                ],
            ...
            'hospitality' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-building-library','title' => 'London Launch (2025)', 'desc' => 'The first African conglomerate of this scale to establish premium hospitality and nightlife in London.'],
                    ['icon' => 'hi-fire','title' => 'Premium Dining',    'desc' => 'Curated menus drawing on African and international culinary traditions in premium settings.'],
                    ['icon' => 'hi-musical-note',         'title' => 'Nightlife & Events',  'desc' => 'High-energy entertainment venues with live performances, DJs, and bespoke corporate events.'],
                ],
                'services'    => [
                    ['icon' => 'hi-fire','title' => 'Fine Dining',    'desc' => 'Premium restaurant experiences with curated menus and exceptional service.'],
                    ['icon' => 'hi-musical-note',          'title' => 'Nightlife',       'desc' => 'Premium nightclub and entertainment venues for discerning clientele.'],
                    ['icon' => 'hi-calendar', 'title' => 'Private Events',  'desc' => 'Private dining, corporate events, and bespoke function hosting.'],
                    ['icon' => 'hi-beaker',     'title' => 'Bar & Lounge',    'desc' => 'Curated cocktail bars and premium lounge experiences.'],
                ],
            ...
            'wellness' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-building-library','title' => 'London Operational',    'desc' => 'Active wellness and beauty services within our London property — part of the integrated hospitality offering.'],
                    ['icon' => 'hi-heart',        'title' => 'Signature Treatments',  'desc' => 'Bespoke spa journeys combining traditional African wellness practices with global techniques.'],
                    ['icon' => 'hi-academic-cap',  'title' => 'Training Academy',      'desc' => 'Professional beauty and wellness training programmes producing qualified practitioners.'],
                ],
                'services'    => [
                    ['icon' => 'hi-heart',       'title' => 'Spa Treatments',      'desc' => 'Signature massages, facials, body wraps, and holistic wellness treatments.'],
                    ['icon' => 'hi-sparkles',    'title' => 'Beauty Services',      'desc' => 'Hair, nail, skin, and full beauty salon services.'],
                    ['icon' => 'hi-sparkles',        'title' => 'Wellness Programmes',  'desc' => 'Holistic wellness, meditation, nutrition, and lifestyle coaching.'],
                    ['icon' => 'hi-academic-cap', 'title' => 'Training Academy',     'desc' => 'Professional beauty and wellness practitioner training and certification.'],
                ],
            ...
            'properties' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-building-library','title' => 'London Property (2025)', 'desc' => 'Prime commercial property acquired in London — housing CJ Restaurants, Nightclubs, and Beauty Spa operations.'],
                    ['icon' => 'hi-globe-alt',        'title' => 'Multi-Continental',      'desc' => 'Active portfolio across South Africa, Zimbabwe, the United Kingdom, and the United States.'],
                    ['icon' => 'hi-arrow-trending-up',  'title' => 'Long-Term Value',        'desc' => 'Strategic acquisition of high-growth real estate across key African and international markets.'],
                ],
                'services'    => [
                    ['icon' => 'hi-building-office',  'title' => 'Commercial Properties','desc' => 'Office buildings, retail spaces, commercial parks, and mixed-use developments.'],
                    ['icon' => 'hi-home',      'title' => 'Residential Portfolio', 'desc' => 'Luxury homes, apartment complexes, and premium residential estates.'],
                    ['icon' => 'hi-chart-bar', 'title' => 'Property Investment',   'desc' => 'Strategic acquisition, valuation, and real estate portfolio management.'],
                    ['icon' => 'hi-key',       'title' => 'Property Management',   'desc' => 'Full-service management including leasing, maintenance, and tenant relations.'],
                ],
            ...
            'spirits' => [
                ...
                'highlights'  => [
                    ['icon' => 'hi-building-office','title' => 'Chicago HQ',          'desc' => 'Building acquired in Chicago, Illinois — the Group\'s debut in manufacturing and the North American market.'],
                    ['icon' => 'hi-globe-alt',           'title' => 'Global Distribution', 'desc' => 'US market primary, with KwaZulu-Natal and Lesotho hubs serving Africa and Zimbabwe expansion in negotiation.'],
                    ['icon' => 'hi-star',            'title' => 'Premium Positioning', 'desc' => 'Entering the US premium spirits market — one of the world\'s largest and most competitive consumer categories.'],
                ],
                'services'    => [
                    ['icon' => 'hi-beaker',         'title' => 'CJ Vodka Range',      'desc' => 'Premium vodka expressions crafted to international luxury standards for the US market.'],
                    ['icon' => 'hi-building-storefront', 'title' => 'Distribution',         'desc' => 'International distribution partnerships across key global markets — US, Africa, and beyond.'],
                    ['icon' => 'hi-users',          'title' => 'Brand Partnerships',   'desc' => 'Strategic co-branding and hospitality partnerships with premium venues worldwide.'],
                    ['icon' => 'hi-star',           'title' => 'Brand Experiences',    'desc' => 'Exclusive events, activations, and immersive brand experiences globally.'],
                ],
