...
<section class="hero">
    ...
    <div class="hero-scroll"><span>Scroll</span><i class="fa-solid fa-chevron-down" aria-hidden="true"></i></div>
</section>
        ...
        <div class="about-grid">
            <div class="about-text">
                ...
                <div style="margin-top:var(--space-3);" class="reveal reveal-delay-3">
                    <a href="{{ route('about') }}" class="btn btn-link">Read Our Full Story <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
                </div>
            </div>
        ...
        <div class="grid-3">
            <div class="card card-project reveal">
                <div class="project-img" style="height:220px;border-radius:8px;overflow:hidden;">
                    <img src="{{ asset('images/pages/project-sandton.jpg') }}" alt="Sandton Hydon Park Mall" style="width:100%;height:100%;object-fit:cover;">
                </div>
                ...
                <div class="project-location"><i class="fa-solid fa-location-dot" style="font-size:13px" aria-hidden="true"></i> Harare, Zimbabwe</div>
                <span class="badge-status badge-development">In Development · US$670M</span>
            </div>
            <div class="card card-project reveal reveal-delay-1">
                <div class="project-img" style="height:220px;border-radius:8px;overflow:hidden;">
                    <img src="{{ asset('images/pages/project-london.jpg') }}" alt="London Market Entry" style="width:100%;height:100%;object-fit:cover;">
                </div>
                ...
                <div class="project-location"><i class="fa-solid fa-location-dot" style="font-size:13px" aria-hidden="true"></i> London, United Kingdom</div>
                <span class="badge-status badge-operational">Operational · 2025</span>
            </div>
            <div class="card card-project reveal reveal-delay-2">
                <div class="project-img" style="height:220px;border-radius:8px;overflow:hidden;">
                    <img src="{{ asset('images/pages/project-chicago.jpg') }}" alt="Chicago Manufacturing" style="width:100%;height:100%;object-fit:cover;">
                </div>
                ...
                <div class="project-location"><i class="fa-solid fa-location-dot" style="font-size:13px" aria-hidden="true"></i> Chicago, Illinois, USA</div>
                <span class="badge-status badge-operational">Operational · 2025</span>
            </div>
        </div>
        <div style="text-align:center;margin-top:var(--space-5);">
