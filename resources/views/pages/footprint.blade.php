    ...
    <div class="container">
        ...
        <div class="grid-3">
            <div class="region-card reveal">
                <div class="region-icon"><i class="ti ti-map"></i></div>
            ...
            <div class="region-card reveal reveal-delay-1">
                <div class="region-icon"><i class="ti ti-building-arch"></i></div>
            ...
            <div class="region-card reveal reveal-delay-2">
                <div class="region-icon"><i class="ti ti-world"></i></div>
        ...
        <div class="grid-3">
            <div class="office-card reveal">
                ...
                <div class="office-card-body">
                    ...
                    <div class="office-detail"><i class="ti ti-map-pin"></i> Ntambanana, KwaZulu-Natal, South Africa</div>
                    <div class="office-detail"><i class="ti ti-mail"></i> enquiries@cjglobalexpressgroup.com</div>
                    <div class="office-detail"><i class="ti ti-mail"></i> sircj@cjglobalexpressgroup.co.za</div>
                </div>
            </div>
            ...
            <div class="office-card reveal reveal-delay-1">
                ...
                <div class="office-card-body">
                    ...
                    <div class="office-detail"><i class="ti ti-map-pin"></i> River Crescent Rd, Kelvin West, Bulawayo, Zimbabwe</div>
                    <div class="office-detail"><i class="ti ti-mail"></i> founder@cjglobalexpressgroup.com</div>
                </div>
            </div>
            ...
            <div class="office-card reveal reveal-delay-2">
                ...
                <div class="office-card-body">
                    ...
                    <div class="office-detail"><i class="ti ti-map-pin"></i> London, United Kingdom</div>
                    <div class="office-detail"><i class="ti ti-building"></i> Hospitality &amp; Wellness Operations</div>
                </div>
            </div>
        </div>
    </div>
