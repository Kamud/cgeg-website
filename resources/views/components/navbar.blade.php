...
<div class="mobile-menu" id="mobileMenu" role="dialog" aria-label="Mobile navigation" aria-hidden="true">
    <div class="mobile-menu-item">
        <a href="{{ route('home') }}"       class="mobile-menu-link {{ request()->routeIs('home')        ? 'active' : '' }}">Home       <i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a>
    </div>
    <div class="mobile-menu-item">
        <a href="{{ route('about') }}"      class="mobile-menu-link {{ request()->routeIs('about')       ? 'active' : '' }}">About      <i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a>
    </div>
    <div class="mobile-menu-item">
        <a href="{{ route('divisions') }}"  class="mobile-menu-link {{ request()->routeIs('divisions*')  ? 'active' : '' }}">Divisions  <i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a>
    </div>
    <div class="mobile-menu-item">
        <a href="{{ route('projects') }}"   class="mobile-menu-link {{ request()->routeIs('projects')    ? 'active' : '' }}">Projects   <i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a>
    </div>
    <div class="mobile-menu-item">
        <a href="{{ route('footprint') }}"  class="mobile-menu-link {{ request()->routeIs('footprint')   ? 'active' : '' }}">Global Footprint <i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a>
    </div>
    <div class="mobile-menu-item">
        <a href="{{ route('foundation') }}" class="mobile-menu-link {{ request()->routeIs('foundation')  ? 'active' : '' }}">Foundation <i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a>
    </div>
    <div class="mobile-menu-item">
    ...
    <div class="mobile-cta-wrap mobile-menu-item">
        <a href="{{ route('contact') }}" class="btn btn-primary">Get in Touch <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
    </div>
</div>
