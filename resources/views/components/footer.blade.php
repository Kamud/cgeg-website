    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="footer-brand">
                ...
                <p>A diversified global conglomerate driving growth across construction, mining, logistics, properties, hospitality and beyond. Operating in 32+ countries.</p>
                <div style="margin-top: var(--space-3);">
                    <div class="footer-contact-item">
                        <i class="ti ti-map-pin"></i>
                        <span>Ntambanana, KwaZulu-Natal, South Africa</span>
                    </div>
                    <div class="footer-contact-item">
                        <i class="ti ti-mail"></i>
                        <a href="mailto:enquiries@cjglobalexpressgroup.com">enquiries@cjglobalexpressgroup.com</a>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="mailto:enquiries@cjglobalexpressgroup.com">General Enquiries</a></li>
                    <li><a href="mailto:founder@cjglobalexpressgroup.com">Founder's Office</a></li>
                    <li><a href="mailto:sircj@cjglobalexpressgroup.co.za">SA Office</a></li>
                </ul>
            </div>
