        ...
        <div class="footer-top">
            <div class="footer-brand">
                ...
                <div style="margin-top:var(--space-3);">
                    <div class="footer-contact-item"><i class="fa-solid fa-location-dot" aria-hidden="true"></i><span>CJ Global Mall, Bukhanana Reserve, KwaZulu-Natal, South Africa</span></div>
                    <div class="footer-contact-item"><i class="fa-solid fa-phone" aria-hidden="true"></i><a href="tel:+27669471290">+27 66 947 129</a></div>
                    <div class="footer-contact-item"><i class="fa-solid fa-phone" aria-hidden="true"></i><a href="tel:+263772701826">+263 77 270 1826</a></div>
                    <div class="footer-contact-item"><i class="fa-solid fa-envelope" aria-hidden="true"></i><a href="mailto:reception@cjglobalexpressgroup.com">reception@cjglobalexpressgroup.com</a></div>
                </div>
            </div>
